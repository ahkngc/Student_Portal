...
def index():
    ...
    student = StudentManager.get_current_student()
    ...
    # GRADES PAGE
        ...
        gm = GradeManager()
        grades, numeric_scores = gm.read_grades(student.id)
        avg_grade = gm.calculate_avg_grade(numeric_scores)
        grades_letter = {sub: gm.convert_grade(score) for sub, score in grades.items()}
